...
import { fetchAsyncMovieorShowDetails, getSelectMovieorShow, removeSelectedMovieOrShow } from '../../features/movies/movieSlice';
...
const MovieDetails = () => {
  ...
  return (<div>
    <div className="movie-section">
      ...
      <div className="section-right"><img src={data.Poster} alt={data.title} /></div>
      </>}
